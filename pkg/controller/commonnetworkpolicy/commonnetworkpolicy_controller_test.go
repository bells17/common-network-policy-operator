...
func TestReconcile(t *testing.T) {
	...
	instance := &commonnetworkpoliciesv1alpha1.CommonNetworkPolicy{ObjectMeta: metav1.ObjectMeta{Name: "foo"}}
	...
	// Create the CommonNetworkPolicy object and expect the Reconcile and Deployment to be created
